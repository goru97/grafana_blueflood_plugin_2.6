    ...
    function (angular, _, kbn, $, dateMath) {
        ...
        module.factory('BluefloodDatasource', function ($q, backendSrv, templateSrv) {
            ...
            BluefloodDatasource.prototype.query = function(options) {
                try {
                    var graphOptions = {
                        from: this.translateGraphiteTime(options.rangeRaw.from, false),
                        until: this.translateGraphiteTime(options.rangeRaw.to, true),
            ...
            BluefloodDatasource.prototype.convertDataPointsToMs = function(result) {
            ...
            BluefloodDatasource.prototype.translateGraphiteTime = function(date, roundUp) {
                if (_.isString(date)) {
                    if (date === 'now') {
                        return 'now';
                    }
            ...
            BluefloodDatasource.prototype.metricFindQuery = function(query) {
                var interpolated;
                try {
            ...
            BluefloodDatasource.prototype.testDatasource = function() {
            ...
            BluefloodDatasource.prototype.loadDashboard = function(dashName) {
                return this.doGraphiteRequest({method: 'GET', url: '/dashboard/load/' + encodeURIComponent(dashName) });
            };

            BluefloodDatasource.prototype.doGraphiteRequest = function(options) {
                if (this.basicAuth || this.withCredentials) {
                    options.withCredentials = true;
                }
                if (this.basicAuth) {
                ...
                alert(JSON.stringify(options.data)) //TODO: Remove this afterwards
                return backendSrv.datasourceRequest(options);
            };

            BluefloodDatasource.prototype._seriesRefLetters = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ';

            BluefloodDatasource.prototype.buildGraphiteParams = function(options, scopedVars) {
